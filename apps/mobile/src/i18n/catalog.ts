...
const PHRASES: Translation[] = [
  ...
  { en: "Current persona data package is loaded.", zh: "当前演示用户的数据包已加载。", ja: "現在のデモペルソナのデータパッケージを読み込み済みです。" },
  { en: "API connection", zh: "API 连接", ja: "API 接続" },
  { en: "Checking /health…", zh: "正在检查 /health…", ja: "/health を確認中…" },
  { en: "Connection has not been checked.", zh: "尚未检查连接状态。", ja: "接続状態はまだ確認されていません。" },
  { en: "Check", zh: "检查", ja: "確認" },
  { en: "Not enough data", zh: "数据不足", ja: "データ不足" },
  { en: "Comparison unavailable", zh: "无法进行比较", ja: "比較できません" },
  { en: "Load a demo persona to calculate this summary.", zh: "请先加载演示用户以计算此摘要。", ja: "このサマリーを計算するにはデモペルソナを読み込んでください。" },
  ...
  { en: "No validation findings were reported.", zh: "未发现需要报告的校验问题。", ja: "報告すべき検証上の問題はありませんでした。" },
  { en: "Load demo data to view the raw series.", zh: "请加载演示数据以查看原始序列。", ja: "生の時系列を表示するにはデモデータを読み込んでください。" },
  { en: "No numeric observations are available in this range.", zh: "此时间范围内没有可用的数值观测。", ja: "この期間には数値観測データがありません。" },
  { en: "check", zh: "检查", ja: "確認" },
  {
  ...
  { en: "No statement was returned for this section.", zh: "此部分未返回内容。", ja: "このセクションには回答文がありません。" },
  ...
  { en: "Bounded Agent workflow", zh: "受约束的智能体工作流", ja: "制約付きエージェントワークフロー" },
  {
  ...
  { en: "Recent 7 days vs 30-day baseline", zh: "近 7 天与 30 天基线对比", ja: "直近7日間と30日ベースラインの比較" },
  {
  ...
  { en: "No current action is available yet.", zh: "目前还没有可用的行动。", ja: "現在利用できるアクションはまだありません。" },
  ...
  { en: "Synthetic package loaded", zh: "合成数据包已加载", ja: "合成データパッケージ読み込み済み" },
  ...
  { en: "Import a persona before requesting raw observations.", zh: "请先导入演示用户，再请求原始观测。", ja: "生の観測を取得する前にペルソナをインポートしてください。" },
  ...
  { en: "Health behaviour coaching question", zh: "健康行为辅导问题", ja: "健康行動コーチングの質問" },
  { en: "Ask about recent changes and a realistic plan", zh: "询问近期变化和可执行的计划", ja: "最近の変化と現実的なプランについて質問" },
  { en: "Analyse and answer", zh: "分析并回答", ja: "分析して回答" },
  { en: "Load the selected synthetic persona first.", zh: "请先加载所选合成演示用户。", ja: "先に選択した合成ペルソナを読み込んでください。" },
  ...
  { en: "No ordinary action plan was returned.", zh: "未返回常规行动计划。", ja: "通常のアクションプランは返されませんでした。" },
  { en: "When to seek professional help", zh: "何时寻求专业帮助", ja: "専門家に相談すべきタイミング" },
  { en: "What I am uncertain about", zh: "我仍不确定的部分", ja: "不確かな点" },
  { en: "No coaching answer has been requested yet.", zh: "尚未请求健康教练回答。", ja: "まだコーチング回答をリクエストしていません。" },
  ...
  { en: "Retrieving Patient Evidence…", zh: "正在检索用户证据…", ja: "ユーザーエビデンスを取得中…" },
  { en: "No Patient Evidence matched this bounded window.", zh: "此限定时间窗口内没有匹配的用户证据。", ja: "この限定期間に一致するユーザーエビデンスはありません。" },
  ...
  { en: "Retrieving guideline evidence…", zh: "正在检索指南证据…", ja: "ガイドラインのエビデンスを取得中…" },
  { en: "No external guideline chunk matched this question.", zh: "没有与此问题匹配的外部指南片段。", ja: "この質問に一致する外部ガイドラインのチャンクはありません。" },
  ...
  { en: "Account optional · anonymous use remains available.", zh: "账户可选 · 仍可匿名使用。", ja: "アカウントは任意です · 匿名でも利用できます。" },
  ...
  { en: "Load a synthetic persona on Today or Health Data first.", zh: "请先在“今日”或“健康数据”中加载合成演示用户。", ja: "まず「今日」または「健康データ」で合成ペルソナを読み込んでください。" },
  ...
  { en: "Reason, constraint or what made this difficult", zh: "原因、限制或困难之处", ja: "理由、制約、難しかった点" },
  ...
  { en: "Add a reason before Reject or Not completed.", zh: "选择“拒绝”或“未完成”前请填写原因。", ja: "「却下」または「未完了」を選ぶ前に理由を入力してください。" },
  { en: "Why this version changed", zh: "此版本为何发生变化", ja: "このバージョンが変わった理由" },
  { en: "Earliest retained plan version.", zh: "保留的最早计划版本。", ja: "保持されている最も古いプランバージョンです。" },
  { en: "Earliest retained plan version; there is no earlier version to compare.", zh: "这是保留的最早计划版本，没有更早版本可供比较。", ja: "保持されている最も古いプランバージョンのため、比較できる以前のバージョンはありません。" },
  { en: "The number of retained actions changed between these plan versions.", zh: "这些计划版本之间保留的行动数量发生了变化。", ja: "これらのプランバージョン間で保持されるアクション数が変わりました。" },
  { en: "No material action, difficulty or feedback-status change from the previous version.", zh: "与上一版本相比，行动、难度或反馈状态没有实质变化。", ja: "前のバージョンから、アクション、難易度、フィードバック状態に重要な変化はありません。" },
  { en: "Rationale:", zh: "原因：", ja: "理由：" },

  { en: "Graduate student with a recent sleep and workload disruption.", zh: "最近睡眠和工作负荷受到影响的研究生。", ja: "最近、睡眠と作業負荷が乱れている大学院生。" },
  { en: "Remote worker with stable sleep but a recent drop in daily movement.", zh: "睡眠稳定但近期日常活动量下降的远程工作者。", ja: "睡眠は安定しているものの、最近の日常活動量が減っているリモートワーカー。" },
  { en: "Restore a regular evening routine while keeping activity manageable.", zh: "在保持活动量可承受的同时恢复规律晚间作息。", ja: "無理のない活動量を保ちながら、規則的な夜の習慣を取り戻す。" },
  { en: "Rebuild regular movement breaks without making the workday harder.", zh: "在不增加工作日负担的前提下恢复规律活动休息。", ja: "仕事日の負担を増やさず、定期的な運動休憩を取り戻す。" },
  { en: "I have felt more tired recently. What changed, and what is realistic this week?", zh: "我最近感觉更疲惫。发生了什么变化？这周做什么比较现实？", ja: "最近、以前より疲れを感じます。何が変わり、今週は何をするのが現実的ですか？" },
  { en: "My activity has dropped while working from home. What changed and what can I try?", zh: "居家办公后我的活动量下降了。发生了什么变化？我可以尝试什么？", ja: "在宅勤務で活動量が減りました。何が変わり、何を試せますか？" },
  { en: "Start winding down at the same time tonight.", zh: "今晚在固定时间开始放松准备入睡。", ja: "今夜は同じ時刻から就寝前のリラックスを始める。" },
  { en: "Take a 10-minute easy walk after dinner.", zh: "晚饭后轻松步行 10 分钟。", ja: "夕食後に10分間、無理のない散歩をする。" },
  { en: "Protect a 30-minute screen-free period before bed.", zh: "睡前留出 30 分钟不用屏幕。", ja: "就寝前に30分間、画面を見ない時間を確保する。" },
  { en: "Take a short movement break during the workday.", zh: "工作期间安排一次短暂活动休息。", ja: "仕事中に短い運動休憩を取る。" },
  { en: "Write down tomorrow's top three tasks before winding down.", zh: "放松前写下明天最重要的三件事。", ja: "就寝前のリラックスに入る前に、明日の重要な3つのタスクを書き出す。" },
  { en: "Repeat the 10-minute easy walk after dinner.", zh: "再次在晚饭后轻松步行 10 分钟。", ja: "夕食後の10分間の無理のない散歩をもう一度行う。" },
  { en: "Review which small routine felt easiest to keep.", zh: "回顾哪一个小习惯最容易坚持。", ja: "どの小さな習慣が最も続けやすかったか振り返る。" },
  { en: "Take a five-minute movement break after the first work block.", zh: "第一个工作时段后活动 5 分钟。", ja: "最初の作業ブロックの後に5分間の運動休憩を取る。" },
  { en: "Walk for 10 minutes after lunch.", zh: "午饭后步行 10 分钟。", ja: "昼食後に10分間歩く。" },
  { en: "Stand and stretch once during the afternoon.", zh: "下午起身伸展一次。", ja: "午後に一度立ってストレッチする。" },
  { en: "Place the next movement break on the calendar before work starts.", zh: "工作开始前把下一次活动休息加入日历。", ja: "仕事を始める前に次の運動休憩をカレンダーに入れる。" },
  { en: "Take a short walk before the final work block.", zh: "最后一个工作时段前短暂步行。", ja: "最後の作業ブロックの前に短い散歩をする。" },
  { en: "Repeat the easiest movement break from earlier in the week.", zh: "重复本周早些时候最容易完成的活动休息。", ja: "今週前半で最もやりやすかった運動休憩を繰り返す。" },
  { en: "Review which cue made movement easiest to remember.", zh: "回顾哪一种提示最能帮助自己记得活动。", ja: "どの合図が運動を思い出すのに最も役立ったか振り返る。" },
  { en: "A deliberately small behaviour-support action grounded in the selected synthetic demo context.", zh: "基于所选合成演示情境而刻意设计的小型健康行为支持行动。", ja: "選択した合成デモの文脈に基づき、意図的に小さく設計した健康行動支援アクション。" },
];
...
function dynamicTranslation(locale: AppLocale, value: string): string | null {
  ...
  if (match?.[1]) {
    return locale === "zh" ? `请求 ${match[1]}` : locale === "ja" ? `リクエスト ${match[1]}` : value;
  }
  match = /^Version (\d+)$/.exec(value);
  if (match?.[1]) {
    return locale === "zh" ? `版本 ${match[1]}` : locale === "ja" ? `バージョン ${match[1]}` : value;
  }
  ...
  if (match?.[1]) {
    return locale === "zh" ? `覆盖率 ${match[1]}%` : locale === "ja" ? `カバレッジ ${match[1]}%` : value;
  }
  match = /^Connected · (.+)$/.exec(value);
  if (match?.[1]) {
    return locale === "zh" ? `已连接 · ${match[1]}` : locale === "ja" ? `接続済み · ${match[1]}` : value;
  }
  match = /^Loading (.+)…$/.exec(value);
  if (match?.[1]) {
    return locale === "zh" ? `正在加载${match[1]}…` : locale === "ja" ? `${match[1]}を読み込み中…` : value;
  }
  ...
  if (match?.[1]) {
    return locale === "zh" ? `导入时间 ${match[1]}` : locale === "ja" ? `インポート日時 ${match[1]}` : value;
  }
  ...
  if (match?.[1] && match[2]) {
    return locale === "zh" ? `片段 ${match[1]} · 得分 ${match[2]}` : locale === "ja" ? `チャンク ${match[1]} · スコア ${match[2]}` : value;
  }
  return null;
}
...
export function translateStaticText(locale: AppLocale, input: string): string {
  ...
  return translated === null || translated === undefined ? input : `${leading}${translated}${trailing}`;
}
